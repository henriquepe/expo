 ...
 * Returning families would probably be "more correct" but would break loading fonts at runtime because loading e.g. Inter would succeed and then loading Inter-Bold would be skipped (both are Inter family).
 * For now, providing a postScript name as `fontFamily` style works because RN core is forgiving about this:  https://github.com/react/react-native/blob/7115c2b97eba100ccb1230aaaeba6c0a5f73c498/packages/react-native/ReactCommon/react/renderer/textlayoutmanager/platform/ios/react/renderer/textlayoutmanager/RCTFontUtils.mm#L359
 */
