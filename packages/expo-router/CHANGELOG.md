...
- Abandon in-flight loader requests and abort when navigation is cancelled ([#48451](https://github.com/expo/expo/pull/48451) by [@hassankhan](https://github.com/hassankhan))
